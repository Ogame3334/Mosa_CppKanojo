...
private:
	...
	// 左右選択ボタン
	ogm::Button<Triangle> leftButton{ Triangle(100, 350, 80, 270_deg), U"L" };
	ogm::Button<Triangle> rightButton{ Triangle(1400, 350, 80, 90_deg), U"R" };
	...
	bool sceneLock;	// シーン遷移ロック（trueの間はシーン遷移しない）
public:
    ...
    void update() override
	{
		...
		if ((MouseL.up() || KeyEnter.up()) && this->sceneLock == false) { changeScene(U"Game"); }
	...
	void draw() const override
	{
		...
		FontAsset(U"TitleFont")(this->mScreen).drawAt(1000, 500);
